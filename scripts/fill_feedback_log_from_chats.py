...
def _html_row(case_id, timestamp, facts, disputes, sections, additional_info, case_laws, opinion):
    ...
    return (
        ...
        '            <td class="editable"><select data-id="' + cid + '" data-field="hg-router" onchange="markDirty()"><option value="">—</option><option value="Legal Opinion">Legal Opinion</option><option value="Direct search/lookup">Direct search/lookup</option><option value="Non Legal">Non Legal</option></select></td>\n'
