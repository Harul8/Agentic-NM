...
**What it controls:** The single message shown when we stop asking questions and start searching bare acts and case laws (e.g. “Thank you. I have noted the facts. I shall now research…”).

**Where to change:** `prompts/advocate_prompts.py` → **`TRANSITION_TO_RESEARCH`**

**You tell me:** e.g. “Step 4: I want it to say [your exact sentence].”
