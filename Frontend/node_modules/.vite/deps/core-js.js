    ...
    if (!NATIVE_SYMBOL) {
      $Symbol = function Symbol2() {
        ...
        var setter = function(value) {
          var $this = this === void 0 ? global : this;
  ...
  "node_modules/core-js/modules/esnext.uint8-array.from-base64.js"() {
    ...
    if (Uint8Array) $({ target: "Uint8Array", stat: true, forced: true }, {
      fromBase64: function fromBase64(string) {
        ...
        } else if (strict) throw new SyntaxError2("Input is not correctly padded");
        ...
        var at = function(shift) {
          ...
          if (!hasOwn(alphabet, chr)) throw new SyntaxError2('Bad char in input: "' + chr + '"');
        ...
        if (lastChunkSize === 2) {
          if (strict && bytes[byteLength - 2] !== 0) throw new SyntaxError2(EXTRA_BITS);
          byteLength -= 2;
        } else if (lastChunkSize === 3) {
          if (strict && bytes[byteLength - 1] !== 0) throw new SyntaxError2(EXTRA_BITS);
          byteLength--;
        }
  ...
  "node_modules/core-js/modules/esnext.uint8-array.from-hex.js"() {
    ...
    if (Uint8Array) $({ target: "Uint8Array", stat: true, forced: true }, {
      fromHex: function fromHex(string) {
        ...
        if (stringLength % 2) throw new SyntaxError2("String should have an even number of characters");
        if (exec(NOT_HEX, string)) throw new SyntaxError2("String should only contain hex characters");
...
var require_web_self = __commonJS({
  "node_modules/core-js/modules/web.self.js"() {
    ...
    try {
      if (DESCRIPTORS) {
        descriptor = Object.getOwnPropertyDescriptor(global, "self");
