"""
Check indexing candidates against the internal vector store and within web results
to avoid re-indexing the same act/judgment. Uses:
- Similarity check on short title (internal vs web, web vs web)
- Optional first-two-pages comparison when title similarity is borderline
"""
