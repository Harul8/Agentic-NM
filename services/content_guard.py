"""
Content Guard — query safety, input sanitization, and abuse detection.

Lightweight, LLM-free safety layer that runs BEFORE any LLM call.
Uses pattern matching and keyword detection (no external dependencies).

Functions:
    check_query_safety(text)  → {"safe": bool, "reason": str, "risk_level": str}
