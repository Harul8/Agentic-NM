"""
Tier Manager — Single source of truth for freemium logic.

Handles:
- Query counting and daily limit enforcement
- Feature access checks per tier
- Tier info for frontend display
- User tier upgrades

All tier logic lives here — api_server.py just calls these functions.
"""
