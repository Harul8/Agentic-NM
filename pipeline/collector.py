"""
pipeline/collector.py — Adaptive advocate-style intake / fact collection.
"""
import json
import logging
import os
...
from core.llm import ask_llm, set_request_model_override
...
def _run_compact_intake_state(
    ...
    if _ENABLE_INTAKE_FEWSHOT:
        try:
            from training.few_shot import get_intake_state_example_pack
...
def _run_next_question_from_state(
    ...
    *,
    ...
    if _ENABLE_INTAKE_FEWSHOT:
        try:
            from training.few_shot import get_intake_reply_example_pack
