...
def retrieve_bare_acts_for_dispute(
    ...
    """
    from core.retriever import search_bare_acts_auto, search_bare_acts_filtered
...
def generate_response_v2(
    ...
    if not interactive_fast_path:
        try:
            from pipeline.intent import extract_research_intent
    ...
    def _retrieve_dispute(dispute):
        ...
        if retrieve_acts:
            if interactive_fast_path:
                from core.retriever import search_bare_acts_fast, search_bare_acts_runtime
                queries_ba = (
        ...
        if retrieve_case_laws_flag:
            ...
            if interactive_fast_path:
                from core.retriever import search_case_summaries_fast, search_case_laws_runtime
            ...
            if case_d and _ENABLE_CITATION_GRAPH_EXPANSION and not interactive_fast_path:
                try:
                    ...
                    from core.retriever import load_chunks as _hr_load_chunks
    ...
    try:
        from core.retriever import _trace_label_chunk
...
def _generate_interactive_fast_opinion(
    ...
    if _ENABLE_RUNTIME_FEWSHOT:
        try:
            from training.few_shot import get_opinion_example
